...
Since a distinct liquid state is only formed below the critical point, intermolecular interactions must be sufficiently strong to keep the molecules bound together in this liquid phase, otherwise they would have been separated and exist as a gas. These intermolecular interactions are characterised by LJ interaction strength $\varepsilon$, and for liquid, the interaction strength must be at least comparable to thermal energy of the particles. This relation can be qualitatively expressed by
\[
\frac{k_BT}{\varepsilon}\sim1,
\]
where the left-hand side correpsonds the definition of the temperature in reduced unit, $T^*$, in the simulation.
\[
